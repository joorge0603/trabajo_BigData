...
```{r, include=FALSE}
temporada_21 <- rio::import(here::here("datos", "atp_2021.xlsx")) %>%
  select(ATP, Date, Series, Surface, Court, Round, Winner, Loser, WRank, LRank)
temporada_20 <- rio::import(here::here("datos", "atp_2020.xlsx")) %>%
  select(ATP, Date, Series, Surface, Court, Round, Winner, Loser, WRank, LRank)
temporada_19 <- rio::import(here::here("datos", "atp_2019.xlsx")) %>%
  select(ATP, Date, Series, Surface, Court, Round, Winner, Loser, WRank, LRank)
temporada_18 <- rio::import(here::here("datos", "atp_2018.xlsx")) %>%
  select(ATP, Date, Series, Surface, Court, Round, Winner, Loser, WRank, LRank)
temporada_17 <- rio::import(here::here("datos", "atp_2017.xlsx")) %>%
  select(ATP, Date, Series, Surface, Court, Round, Winner, Loser, WRank, LRank)
temporada_16 <- rio::import(here::here("datos", "atp_2016.xlsx")) %>%
  select(ATP, Date, Series, Surface, Court, Round, Winner, Loser, WRank, LRank)
temporada_15 <- rio::import(here::here("datos", "atp_2015.xlsx")) %>%
  select(ATP, Date, Series, Surface, Court, Round, Winner, Loser, WRank, LRank)
temporada_14 <- rio::import(here::here("datos", "atp_2014.xlsx")) %>%
  select(ATP, Date, Series, Surface, Court, Round, Winner, Loser, WRank, LRank)
temporada_13 <- rio::import(here::here("datos", "atp_2013.xlsx")) %>%
  select(ATP, Date, Series, Surface, Court, Round, Winner, Loser, WRank, LRank)
temporada_12 <- rio::import(here::here("datos", "atp_2012.xls")) %>% 
  select(ATP, Date, Series, Surface, Court, Round, Winner, Loser, WRank, LRank)
temporada_11 <- rio::import(here::here("datos", "atp_2011.xls")) %>% 
  select(ATP, Date, Series, Surface, Court, Round, Winner, Loser, WRank, LRank)
temporada_10 <- rio::import(here::here("datos", "atp_2010.xls")) %>% 
  select(ATP, Date, Series, Surface, Court, Round, Winner, Loser, WRank, LRank)
temporada_09 <- rio::import(here::here("datos", "atp_2009.xls")) %>% 
  select(ATP, Date, Series, Surface, Court, Round, Winner, Loser, WRank, LRank)
temporada_08 <- rio::import(here::here("datos", "atp_2008.xls")) %>% 
  select(ATP, Date, Series, Surface, Court, Round, Winner, Loser, WRank, LRank)
temporada_07 <- rio::import(here::here("datos", "atp_2007.xls")) %>% 
  select(ATP, Date, Series, Surface, Court, Round, Winner, Loser, WRank, LRank)
temporada_06 <- rio::import(here::here("datos", "atp_2006.xls")) %>% 
  select(ATP, Date, Series, Surface, Court, Round, Winner, Loser, WRank, LRank)
temporada_05 <- rio::import(here::here("datos", "atp_2005.xls")) %>% 
  select(ATP, Date, Series, Surface, Court, Round, Winner, Loser, WRank, LRank)
temporada_04 <- rio::import(here::here("datos", "atp_2004.xls")) %>% 
  select(ATP, Date, Series, Surface, Court, Round, Winner, Loser, WRank, LRank)
temporada_03 <- rio::import(here::here("datos", "atp_2003.xls")) %>% 
  select(ATP, Date, Series, Surface, Court, Round, Winner, Loser, WRank, LRank)
temporada_02 <- rio::import(here::here("datos", "atp_2002.xls")) %>% 
  select(ATP, Date, Series, Surface, Court, Round, Winner, Loser, WRank, LRank)
temporada_01 <- rio::import(here::here("datos", "atp_2001.xls")) %>% 
  select(ATP, Date, Series, Surface, Court, Round, Winner, Loser, WRank, LRank)
temporada_00 <- rio::import(here::here("datos", "atp_2000.xls")) %>% 
  select(ATP, Date, Series, Surface, Court, Round, Winner, Loser, WRank, LRank)

temporadas <- rbind(temporada_21, temporada_20, temporada_19, temporada_18, temporada_17, temporada_16, temporada_15, temporada_14, temporada_13, temporada_12, temporada_11, temporada_10, temporada_09, temporada_08, temporada_07, temporada_06, temporada_05, temporada_04, temporada_03, temporada_02, temporada_01, temporada_00) %>% 
...
ranking90 <- rio::import(here::here("datos", "ranking90.csv"))

ranking00 <- rio::import(here::here("datos", "ranking00.csv"))

ranking10 <- rio::import(here::here("datos", "ranking10.csv"))

ranking20 <- rio::import(here::here("datos", "ranking20.csv")) %>% rename(ranking_date = V1, rank = V2, player = V3, points = V4)

ranking21 <- rio::import(here::here("datos", "ranking21.csv"))

ranking <- rbind(ranking00, ranking10, ranking20, ranking21)

jugadores <- jugadores %>% mutate(name = paste(name_first, name_last, sep = " "), .after = player_id) %>% select(player_id, name, ioc)


ranking <- left_join(ranking, jugadores, by = c("player" = "player_id")) %>% mutate(ranking_date = ymd(ranking_date)) %>% mutate(points = as.numeric(points), rank = as.numeric(rank)) %>% filter(rank <= 100)
```
...
```{r, include=FALSE}
temporada_21 <- rio::import(here::here("datos", "atp_2021.xlsx")) %>%
  select(ATP, Series, Surface, Court, Round, Winner, Loser, WRank, LRank)
temporada_20 <- rio::import(here::here("datos", "atp_2020.xlsx")) %>%
  select(ATP, Series, Surface, Court, Round, Winner, Loser, WRank, LRank)
temporada_19 <- rio::import(here::here("datos", "atp_2019.xlsx")) %>%
  select(ATP, Series, Surface, Court, Round, Winner, Loser, WRank, LRank)
...
```{r}
a <- rbind(temporada_21, temporada_20, temporada_19, temporada_18, temporada_17, temporada_16, temporada_15, temporada_14, temporada_13, temporada_12, temporada_11, temporada_10, temporada_09, temporada_08, temporada_07, temporada_06, temporada_05, temporada_04, temporada_03, temporada_02, temporada_01, temporada_00)
...
```{r}
ranking2 <- rbind(ranking90, ranking00, ranking10, ranking20, ranking21)
...
```{r, include=FALSE}
temporada_21 <- rio::import(here::here("datos", "atp_2021.xlsx")) %>% 
  select(ATP, Date, Series, Surface, Court, Round, Winner, Loser, WRank, LRank, B365W)
temporada_20 <- rio::import(here::here("datos", "atp_2020.xlsx")) %>%
  select(ATP, Date, Series, Surface, Court, Round, Winner, Loser, WRank, LRank, B365W)
temporada_19 <- rio::import(here::here("datos", "atp_2019.xlsx")) %>%
  select(ATP, Date, Series, Surface, Court, Round, Winner, Loser, WRank, LRank, B365W)
...
```{r}
temporadas <- rbind(temporada_02, temporada_03, temporada_04, temporada_05, temporada_06, temporada_07, temporada_08, temporada_09, temporada_10, temporada_11, temporada_12, temporada_13, temporada_14, temporada_15, temporada_16, temporada_17, temporada_18, temporada_19, temporada_20, temporada_21)

zz <- temporadas %>%  filter(Winner %in% c("Federer R.", "Nadal R.", "Djokovic N.")) %>% drop_na(B365W) %>% 
  mutate(Date = year(Date)) %>% 
